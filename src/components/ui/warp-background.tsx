...
const Beam = ({
  ...
  // Light orange theme - using orange/amber hues
  const hue = Math.floor(Math.random() * 60) + 20; // Orange to yellow range (20-80)
      ...
      style={
        {
          ...
          "--width": `${width}`,
          "--aspect-ratio": `${ar}`,
          "--background": `linear-gradient(hsl(${hue} 85% 70%), transparent)`,
...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  beamDelayMin = 0,
  beamDuration = 3,
  gridColor = "hsl(30 40% 80%)", // Light orange grid color
  ...props
}) => {
  ...
  return (
    <div className={cn("relative rounded border border-orange-200 p-20 bg-gradient-to-br from-orange-50 to-amber-50", className)} {...props}>
      <div
        style={
          {
